  ...
  try {
    ...
    if (patient.phone) {
      await smsService.sendSMS(
        patient.phone,
        `MEDLINK ALERT: Emergency access to your health record was granted to ${provider.providerName} at ${provider.facilityName}. If unexpected, contact MedLink support immediately.`
      );
    }
